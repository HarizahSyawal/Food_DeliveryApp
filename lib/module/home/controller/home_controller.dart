...
class HomeController extends State<HomeView> implements MvcController {
  ...
  List<Map<String, dynamic>> categories = [
    {"icon": MdiIcons.foodHotDog, "label": "Burger", "value": "Burger"},
    {"icon": MdiIcons.food, "label": "Taco", "value": "Taco"},
    {"icon": MdiIcons.food, "label": "Chicken", "value": "Chicken"},
    {"icon": MdiIcons.foodForkDrink, "label": "Drink", "value": "Drink"}
  ];
